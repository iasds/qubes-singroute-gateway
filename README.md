...
**qubes-singroute-gateway** 把 sing-box 部署为 NetVM 的透明代理，所有 AppVM **零配置**即可翻墙：
...
╚══════════════════════════════════════════════════════════╝
  ...
  节点: 🇺🇸 US-Node-01 (45ms)    订阅: 2 个, 37 个节点
...
订阅: MyProvider (25 个节点)
  ...
  #  节点名称              延迟    位置
  1  🇺🇸 US-Node-01        45ms    美国
  2  🇯🇵 JP-Node-02        67ms    日本
  3  🇸🇬 SG-Node-03        89ms    新加坡
  4  🇭🇰 HK-Node-04        32ms    香港
  5  🇹🇼 TW-Node-05        55ms    台湾

订阅: BackupProvider (12 个节点)

  6  🇺🇸 US-Backup-01      120ms   美国
  7  🇯🇵 JP-Backup-02      95ms    日本
